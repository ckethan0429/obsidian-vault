...
> Last updated: 2026-08-19 | Total pages: 64
...
- [[agent-workflow-governance]] — 일하는 방식을 상태 전이·증거·승인 게이트로 정의해 에이전트에 위임하는 거버넌스. Maker/Checker/Approver 분리, 멀티모델 검토, 위험 기반 승인. 역할별 예시는 개발자·마케터 문서.
