...
> Last updated: 2026-08-19 | Total pages: 63
...
- [[agent-workflow-governance]] — 일하는 방식을 상태 전이·증거·승인 게이트로 정의해 에이전트에 위임하는 거버넌스, Maker/Checker/Approver 분리, 멀티모델 검토, 위험 기반 승인과 개발 CI/CD 전체 사이클.
