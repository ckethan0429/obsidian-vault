...
- [[agent-runtime-vertical-integration]] — 게이트웨이+메신저 조합에서 전용 컴퓨트까지 묶는 에이전트 스택 수직 통합(Grok Bot)과 isolate 기반 수평 인프라(Cloudflare computer)의 대비, durable runtime 정의 포함.
