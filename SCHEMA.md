...
## Tag Taxonomy
- Domain: ai, ai-research, agents, hermes, quant, market-research, startup, infrastructure, robotics, personal-knowledge, sales, business, strategy
- Models: model, architecture, multimodal, open-weight, benchmark
- People/Orgs: person, company, lab, open-source
- Techniques: training, fine-tuning, inference, alignment, data, optimization, agent, tool-use, backtesting, factor-model, portfolio, virtualization, storage, networking, backup-dr, ci-cd, monitoring, mlops, automation, language-learning, qualification, discovery, negotiation, objection-handling, closing, deep-learning, loss-function, gradient, gradient-descent, backpropagation, study-notes, algorithms, graph-theory, traversal, labor, unions, white-collar, restructuring, prosumer, content, operations, vmware, proxmox
- Systems: serving, evaluation, product, workflow, dashboard, api, private-cloud, gpu, homelab, iot, crm, revenue-ops, plg, marketplace, growth, obsidian, claude-code, claude, anthropic, browser-automation, chrome-cdp, assistant, protocols, orchestration, devtools, checklist, best-practice, workflows, protocol, ops, threads, podcast
